...
def send():
    send1 = "You => " + e.get()
    txt.insert(END,"\n" + send1)
    if e.get() == "Hello" or e.get() == "Hi" or e.get() == "Hey" or e.get() == "hi" or e.get() == "hello" or e.get() == "hii" or e.get() == "hey" or e.get() == "Hii":
        txt.insert(END,"\n" + "Bot => Hey")
    elif e.get() == "How are you":
        txt.insert(END, "\n" + "Bot => Glad you asked..! I'm in high spirit to assist you !!")
...
txt = Text(root,bg="lavender",fg="black")
txt.grid(row=0,column=0,columnspan=2)
e = Entry(root,bg="lightgrey",fg="black",width=100)
e.grid(row=1,column=0)
Button(root,text="Send",command=send,bg="black",fg="white",font=8).grid(row=1,column=1)
